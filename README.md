...
### 6. Анти-имитационные сценарии Code Guard
...
Промт для агента-проверяющего: diff review, контроль архитектуры, чувствительных данных, тестов, расхода токенов и формального выполнения задачи.
